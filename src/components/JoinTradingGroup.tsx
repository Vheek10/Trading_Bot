		...
		<section className="relative overflow-hidden py-16 px-6 text-center">
			...
			<div className="relative max-w-3xl mx-auto text-white">
				...
				<a
					...
					className="bg-indigo-600 px-8 py-3 rounded-lg text-lg font-semibold shadow-lg 
                     transition-all duration-300 hover:bg-indigo-700 hover:scale-110 hover:shadow-2xl">
					Enroll Now
				</a>
			</div>
		</section>
